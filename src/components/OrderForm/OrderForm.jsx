...
const OrderForm = ({ orderForm, setOrderForm, allPrice }) => {
  ...
  const finalPrice = allPrice ?? totalAmount;
    ...
    <div className="fixed inset-0 z-999 flex items-center justify-center bg-black/50 backdrop-blur-sm px-3 h-auto">
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-2xl bg-white shadow-2xl 
        ...
        <button onClick={() => setOrderForm(false)}
          ...
          hover:bg-red-100 transition" > X </button>

        <h2 className="mb-5 text-center text-2xl font-bold text-orange-500">
          Place Your Order
        </h2>
            ...
            <div className="border-t pt-4 space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                {finalPrice >= 1000 ? (
                  ...
                  <span className="text-green-600">Delivery charge ₹48</span>
                )}
              </div>
